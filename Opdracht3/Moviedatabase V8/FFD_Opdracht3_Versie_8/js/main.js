...
request.onload = function () {
    ...
    for (var i = 0; i < movies.length; i++) {
        ...
        footer3.textContent = movies[i].actors[0].actor_name + " - " + movies[i].actors[0].character;
        footer4.textContent = movies[i].actors[1].actor_name + " - " + movies[i].actors[1].character;
        footer5.textContent = movies[i].actors[2].actor_name + " - " + movies[i].actors[2].character;
        footer6.textContent = movies[i].actors[3].actor_name + " - " + movies[i].actors[3].character;
