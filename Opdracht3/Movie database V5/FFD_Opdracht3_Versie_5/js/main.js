...
//      var myPara4 = document.createElement('footer');
        ...
        myPara4.textContent = 'Director: ' + movies[i].directors[0].name;
        footer3.textContent = movies[i].actors[0].actor_name + " as " + movies[i].actors[0].character;
        footer4.textContent = movies[i].actors[1].actor_name + " as " + movies[i].actors[1].character;
        footer5.textContent = movies[i].actors[2].actor_name + " as " + movies[i].actors[2].character;
        footer6.textContent = movies[i].actors[3].actor_name + " as " + movies[i].actors[3].character;
        myArticle.classList = movies[i].genres[0] + ' ' + movies[i].genres[1] + ' ' + movies[i].genres[2] + ' ' + movies[i].genres[3];
        ...
        myArticle.appendChild(footer3);
        myArticle.appendChild(footer4);
        myArticle.appendChild(footer5);
        myArticle.appendChild(footer6);
